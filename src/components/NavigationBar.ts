export type AppleTab = 'decks' | 'insights' | 'settings';

export function renderNavigationBar(activeTab: AppleTab): string {
  const tabs: { id: AppleTab; label: string; icon: string }[] = [
    {
      id: 'decks',
      label: 'Mazos',
